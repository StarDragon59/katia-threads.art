...
const works = [
    ...
    // ---- PUNCH NEEDLE ----
    {
        title: "Punch needle «Геометрия тепла»",
    ...
    {
        title: "Punch needle «Цветущий луг»",
    ...
    },
    {
        ...
        details: "50×60 см, бумага, гуашь",
        story: "Абстрактная композиция , в которой угадываются вода и небо. Мягкие переходы цвета создают медитативное настроение. Работа может стать эскизом для будущего гобелена.",
        status: "Доступна для заказа",
        category: "painting"
    }
];
