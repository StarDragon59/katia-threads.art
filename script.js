...
const works = [
    // ---- ГОБЕЛЕНЫ ----
    {
        ...
        details: "70×100 см, ручное ткачество, шерсть",
    ...
    },
    {
        ...
        details: "60×80 см, ручное ткачество, лён, хлопок",
    ...
    {
        title: "Гобелен «Северное сияние»",
        image: "images/works/gobelen_-08.jpg",
        details: "65×85 см, ручное ткачество, смесовая пряжа",
        story: "Переливы холодных оттенков напоминают магию ночного неба. Отличный выбор для минимализма или сканди.",
        status: "Доступен для заказа",
        category: "gobelen"
    },
    {
        ...
        details: "90×110 см, ручное ткачество, шерсть",
        story: "Крупное монументальное панно, которое «дышит» и зонирует пространство. Глубокие зелёные и охристые тона.",
        status: "Доступен для заказа",
        category: "gobelen"
    },
    {
        title: "Гобелен «Золотая осень»",
        image: "images/works/gobelen_-013.jpg",
        details: "55×75 см, ручное ткачество, шерсть",
    ...
    // ---- PUNCH NEEDLE ----
    {
        ...
        details: "40×40 см, ковровая вышивка (punch needle), хлопок",
